...
if __name__ == "__main__":    
    ...
    # Randomly select 10 samples to concatenate
    number_of_samples_to_keep = len(adata_array) 
    adata_array = random.sample(adata_array, number_of_samples_to_keep)
    ...
    result_file = ROOT_PATH / DATA_DIR / file_name
