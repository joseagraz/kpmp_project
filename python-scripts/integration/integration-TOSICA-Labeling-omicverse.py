...
if __name__ == "__main__":
    ...
    # del ref_adata.var['vst.variance-1']
    # del ref_adata.var['vst.variance.standardized-1']
    # del ref_adata.var['vst.variance.expected-1']
    # del ref_adata.var['vst.mean-1']

    input_file = OUTPUT_DIR / 'single_cell_harmony_results_file.h5ad'
    adata.write_h5ad(input_file, compression='gzip')
    adata = adata[:,ref_adata.var_names]
