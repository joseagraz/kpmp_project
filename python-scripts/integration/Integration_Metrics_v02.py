...
# ------------------------------------------
# https://scib-metrics.readthedocs.io/en/stable/notebooks/lung_example.html#perform-the-benchmark
# Script Information
...
if __name__ == "__main__":    
    ...
    bm = Benchmarker(
        ...
        label_key="celltype",
        embedding_obsm_keys=['Integration_Harmony', 'Integration_scANVI', 'Integration_scVI', 'Scanorama', 'Unintegrated', 'X_umap'],
    ...
    output_file = OUTPUT_DIR / Path(f'{number_of_samples_to_keep}_samples_integration_images_Leiden_resolution_{LEIDEN_RESOLUTION}')    
