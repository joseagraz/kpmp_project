...
if __name__ == "__main__":
    ...
    adata=sc.read_h5ad(input_file) # Need to test saved file, sometimes the file corrupts
    ...
    fig.savefig(IMAGES_PATH/"X_mde_harmony_cell_type.png", dpi=300, bbox_inches='tight') 

    
    fig,ax=plt.subplots(figsize = (1,4))
    ov.pl.cellproportion(adata=adata,celltype_clusters='celltype',
