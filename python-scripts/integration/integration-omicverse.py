...
if __name__ == "__main__":
    ...
    concatenated_file = OUTPUT_DIR / 'rapids_single_cell_concatenated_results_file.h5ad'
    adata=sc.read_h5ad(concatenated_file)

    adata.X=adata.X.astype(np.int64)
    # ------------------------------
    # Ensure that obs_names and var_names are unique and updated
    adata.obs_names_make_unique()  # Ensures unique obs_names
    adata.var_names_make_unique()  # Ensures unique var_names
    # ------------------------------
    ...
    # fig.savefig(IMAGES_PATH/"X_mde_pca.png", dpi=300, bbox_inches='tight')    
    ...
    output_file = OUTPUT_DIR / 'single_cell_cell_labeled_results_file.h5ad'
