...
def read_and_process_data(sample_name: str, root_path: Path, data_dir: str, source_data_path: Path) -> AnnData:
    ...
    """
    file_name = f'{sample_name.strip()}_filtered_feature_bc_matrix_preprocessing-filtered.h5ad'
    output_file = PROCESSED_SAMPLES_DIR / file_name
...
if __name__ == "__main__":
    ...
    # adata=read_and_process_data(sample_names[100], ROOT_PATH, DATA_DIR, SOURCE_DATA_PATH)
