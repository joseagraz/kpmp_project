...
if __name__ == "__main__":
    ...
    # ov.pp.anndata_to_CPU(adata)
    # adata = aggregate_duplicate_obs3(adata)
    adata=clean_anndata(adata)
    
    # Save the combined dataset to a file, overwriting if it already exists
    concatenated_results_file = OUTPUT_DIR / 'concatenated_results_file.h5ad'
    ...
    adata.write_h5ad(OUTPUT_DIR/'kpmp_batch_normlog.h5ad',compression='gzip')
    ...
    ov.utils.embedding(adata,
                ...
                color=['batch','celltype'],show=False)
