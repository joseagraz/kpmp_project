...
if __name__ == "__main__":    
    ...
    adata = sc.read_h5ad(INTEGRATED_OUTPUT_FILE)
    # -------------------------------
    ...
    plt.savefig(IMAGING_DIR / "neighbors_umap_clusters_plot.png", dpi=fig.dpi)
    plt.show() 
    # sc.pl.umap(adata)
    # ---------------------------
    ...
    plt.savefig(IMAGING_DIR / "leiden_umap_clusters_plot.png", dpi=fig.dpi)
    plt.show() 
    # ---------------------------
